...
```text
หาว่ามีคนถือของขวัญกี่คนจนมาถึงคนที่1หรือT
```
...
```text
Step 1:รับค่าต่างๆ
Step 2:สร้างตัวเเปร count เเละcheck
Step 3:ถ้า T คือ 1 ให้พิม 1 ละถ้าไม่ใช่ให้ลูป
Step 4:ลูปโดยใช้While True checkจะมีค่าเปลี่ยนทุกลูป
Step 5:เช็คว่าข้างในเป็น1ไหม ถ้าใช้ก็break ถ้าเป็นT count +=1 ล่ะก็break elseก็ +=1
Step 6:พิมcount
```
