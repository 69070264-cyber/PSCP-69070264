...
```text
เช็คในข้อความว่ามีสระเเต่ล่ะตัวอยู่กี่ตัว
```
...
```text
Step 1:รับข้อความพร้อมlower()
Step 2:count a e i o u เก็บที่ล่ะตัวเเปร
Step 3:เช็คว่าตัวไหมมากกว่า0ก้ให้printตัวนั้น
```
...
```text
เหมือนกัน เพราะ ใช้countในการนับทีล่ะตัว
```
