...
```text
ต้องรับinputสองสี ถ้าตรงเงื่อนไขการผสมข้อใดก็จะได้output สีที่ผสมเเล้ว
```
...
Step 2:สร้างลิสสำหรับกลุ่มสีหลัก
Step 3:หากไม่ใช่ให้print error
Step 4:ถ้ามีInputสีเเดงเเละสีเหลืองให้print ส้ม
Step 5:ถ้ามีInputสีเเดงเเละสีน้ำเงินให้print ม่วง
Step 6:ถ้ามีInputสีน้ำเงินเเละสีเหลืองให้print เขียว
Step 7:ถ้าสีซ้ำให้printสีของมันเอง
```
...
```text
เหมือนกันเพราะต้องเช็คว่าทั้ง2input อันเเรกเเละอันสองเป็นสีอะไรเข้าเงื่อนไขไหน
```
