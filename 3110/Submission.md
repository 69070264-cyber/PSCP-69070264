...
```text
คิดราคาส่งจากจุดต้นทางไปปลายทางโดยที่บวกกับค่าธรรมเนียมน้ำหนัก โดยที่ถ้าไม่อยุ่ในเส้นทางให้print Error
```
...
```text
Step 1:รับเส้นทาง ปลายทาง
Step 2:if เช็คทีล่ะเส้นทาง
Step 3:คิดค่าธรรมเนียมตามเส้นทางนั้น
Step 4:ถ้าไม่อยุ่ในเส้นทางให้print Error
```
...
```text
เหมือนกัน เพราะ ใข้if เช็คทีล่ะเส้นทาง ได้
```
