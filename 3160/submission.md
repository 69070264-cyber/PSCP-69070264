...
```text
รับRange มาล่ะหาว่ามีตัวไหนบ้างที่เป็นจำนวนเฉพาะ
```
...
```text
Step 1: รับค่าRange
Step 2: loop ตามRagne สร้างสร้างลูปซ้อน
Step 3: ใช้ตัวเเปร i ใน loop เเรก mod ด้วย u ในloop สอง
Step 4: เช็คว่าถ้ามันหารตัวอื่นลงตัว ก็ไม่ใช้จำนวนเฉพาะ ถ้า ไม่ ก็เอาi เก็บในlist ล่ะก็Count += 1
Step 5: print list ที่ join " " เเล้ว print Count
```
...
```text
เหมือนกัน เพราะ เราใช้U ที่ล่ะตัวเพื่อเช็คi ที่ล่ะตัว
```
