...
```text
ต้องรับinputตัวเลข จากนั้นเเสดงผลของตั้งเเต่ตัวเลขตัวนั้นจนถึง0ที่หาร10ลงตัว
```
...
```text
Step 1:รับค่าตัวเลข
Step 2:หาตัวเเรกที่หาร10ลงตัว
Step 3:ทำการloopย้อนกลับตั่งเเต่ตัวเเรกจนถึง0ทืล่ะ10
Step 4:สังprintในloop
...
```text
เปลี่ยนจากสั่งprintในloopเป็นสร้างลิสที่ใส่ค่าทั้งหมดในloopล่ะprint ลิสนั้น
```
