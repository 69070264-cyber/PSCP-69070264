...
```text
รับผลโหวต รวมกับผลโหวตมากสุด ล่ะเช็คว่าค่าน้อยสุดที่เป็นไปได้ห่างเกิน2คะเเนนกับค่ามากสุดไหม
```
...
Step 1:รับค่าผลรวม
Step 2:รับค่าmax
Step 3:หาค่าน้อยสุดที่เป็นไปได้
Step 4:เช็คว่าถ้าค่าน้อยสุดที่เป็นไปได้ มากกว่าหรือน้อยกว่า2
...
```text
เหมือนกันเพราะหาminจากการเอาผลรวม-2(max)
```
