...
```text
ให้ลดราคาสินค้าหากมากว่า500 หรือเป็นสมาชิกสหกรณ์
```
...
```text
Step 1:รับว่าเป็นสมาชิกรึไม่
Step 2:ลูปละเก็บราคาสินค้าโดยบวกไปที่ตัวเเปล
Step 3:ถ้าใช่ให้นำผลรวมสินค้าไป * ไปเเปลงตามเงื่อนไข
Step 4:print โดยใช้:.2f
```
...
```text
ต้องใช้import decimal เข้ามาใช้เเทนfloat เพราะคลาดเคลื่อนน้อยกว่า
```
