...
```text
รับค้าอิฐก้อนใหญ่เเละเล็กพร้อมกับเป้าหมายโดยที่ต้องใช้อิฐก้อนเล้กอย่างน้อยกี่ก้อน
```
...
Step 1:รับจำนวนอิฐ
Step 2:นำgoalไปมอด5
Step 3:ถ้าmod ทีออกมามีค่ามากกว่าa ให้print-1
Step 4:printเศษที่เหลือ
```
...
```text
ต้องสร้างตัวเเปลที่เช็ตว่าใช้อิฐก้อนใหญ่จริงไปเท่าไรเพื่อกรณีที่มีอิฐก้อนใหญ่น้อย โดยใช้min เช็ต เเล้วนำไป*5 - goal จะได้เศษที่เหลือจริงๆ
```
