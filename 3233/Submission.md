...
```text
เช็คลอตเตอร์ลี่ของเรากับรางวัลผู้ชนะ ว่าตรงเงื่อนไขที่กำหนดอันไหน ล่ะให้รางวัลตามนั้น
```
...
```text
Step 1:รับลอตเตอร์รี่ของเรากับอันที่เฺฉลย
Step 2:เช็คเงื่อนไขต่าง โดยใช้String Slide ในการเช็ตเลขท้าย 2,3ตัว
Step 3:print ตามเงื่อนไข
```
