...
```text
ต้องรับinputค่าเดือนเเละวัน เดือนที่ 1, 2, 3 เป็น ฤดูหนาว
เดือน 4, 5, 6 เป็น ฤดูใบไม้ผลิ
เดือนที่ 7, 8, 9 เป็น ฤดูร้อน 
เดือน 10, 11, 12 เป็น ฤดูใบไม้ร่วง
หากเดือนนั้นหาร3ลงตัวเเละเป็นวันที่21เป็นต้องไปให้ปัดฤดูขี้น
```
...
Step 2:สร้้างเงื่อนไขว่าอยุ่ในกลุ่มเดือนไหน(1,2,3)(4,5,6)
Step 3:ถ้าหาร3ลงตัว เเละเป็นวันตั้งเเต่21ให้ปัดฤดูขึ่น
Step 4:หากไม่ใช่ให้ใช้ฤดูในกลุ่มเดือนนั้น
Step 5:printฤดูกาล
```
...
```text
เหมือนกันเพราะหากวันมากกว่า21ของเดือน3,6,9,12ให้ใช้ฤดูถัดไป
```
