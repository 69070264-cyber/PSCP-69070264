...
```text
เช็คว่าในA-B มีกี่ตัวที่หารด้วย D เเละได้เศษR
```
...
```text
Step 1:รับA B D R
Step 2:สร้างตัวเเปรcount
Step 3:ลูปในrange A,B+1
Step 4:ใช้if เช็คว่าเศษที่หารด้วยD ใข่Rไหม ถ้าใช่ให้บวก1count
```
...
```text
เหมือนกัน เพราะ ต้องใช้ลูปเช็คในrange
```
