...
```text
รับค่าที่น้ำหนึกจะขยายได้ใน1หน่วยวินาที พร้อมพิกัดบ้านคนเพื่อที่จะได้รู้ว่าบ้านจะจมในวิที่เท่าไร
```
...
```text
Step 1:รับความเร็วหมึกล่ะจำนวนบ้าน
Step 2:loopตามจำหน่วนบ้าน
Step 3:รับพิกัดบ้าน
Step 4:ใช้สูตรหาระยะ
Step 5:หาพื้นที่จากระยะ
Step 6:หาเวลาจากพื้นที่
Step 7:print time
```
...
```text
เพิ่มลิสที่ใสtimeทั้งหมด ล่ะprint ลิสนั้น
```
