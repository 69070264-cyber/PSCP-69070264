...
```text
รับค่าห้องที่อยุ่ล่ะหาทางที่น้อยที่สุดไปหาห้อง1
```
...
```text
Step 1:รับค่าห้อง
Step 2:เช็คว่าห้องอยุ่เเถวไหนโดยใช้sqrt
Step 3:เอาเเถวไปคูณ 2
```
...
```text
ต้องสร้างตัวเเปลเช็คว่ามันเป็นสามเหลี่ยมหัวตั้งรึหัวกลับเพราะหัวกลับสามารถขี้นไปเเถวต่อไปได้เลยไม่ต้องไปขยับในเเถว
```
