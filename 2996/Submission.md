...
```text
ต้องรับinput Textที่จะสับเปลี่ยนพร้อมกับเเปลงเป็นตัวเล็ก เเละOutput indexของTextเเบบสลับกัน
```
...
```text
Step 1:สร้างฟังก์ชั้นสลับตัว
Step 2:รับข้อความมาพร้อมเเปลงให้เป็นตัวพิมพ์เล็ก
Step 3:printIndex เเบบย้อนกลับที่ละตัว
```
...
```text
เหมือนกันเพราะสั้งให้พิมพ์Indexเเบบย้อนกลับ -1 -2 ไปเรื่อยๆ
```
